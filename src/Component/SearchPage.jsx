                                ...
                                return (
                                    <div className='left flex-1 flex flex-col justify-evenly mx-10 flex-wrap'>
                                        <p className='text-lg flex justify-between w-[55%]'>From :
                                            ...
                                            <span className={`cursor-pointer px-2 py-1 text-sm rounded ${selectForm === 'Tablet2' ? 'border-2 border-green-900 shadow shadow-green-400 font-bold' : 'border-dashed border-2 border-zinc-400'}`} onClick={(e) => setSelectForm('Tablet2')}>Tablet2</span>
                                        </p>
                                        <p className='text-lg flex justify-between w-[55%]'>Strength :
                                            <span className={`cursor-pointer px-2 py-1 text-sm rounded ${selectStrength === '100mg' ? 'border-2 border-green-900 shadow shadow-green-400 font-bold' : 'border-dashed border-2 border-zinc-400'}`} onClick={(e) => setSelectStrength('100mg')}>100mg</span>
                                            <span className={`cursor-pointer px-2 py-1 text-sm rounded ${selectStrength === '500mg' ? 'border-2 border-green-900 shadow shadow-green-400 font-bold' : 'border-dashed border-2 border-zinc-400'}`} onClick={(e) => setSelectStrength('500mg')}>500mg</span>
                                        </p>
                                        <p className='text-lg flex justify-between w-[55%]'>Packaging :
                                            <span className={`cursor-pointer px-2 py-1 text-sm rounded ${selectPacking === '5 strips' ? 'border-2 border-green-900 shadow shadow-green-400 font-bold' : 'border-dashed border-2 border-zinc-400'}`} onClick={(e) => setSelectPacking('5 strips')}>5 strips</span>
                                            <span className={`cursor-pointer px-2 py-1 text-sm rounded ${selectPacking === '10 strips' ? 'border-2 border-green-900 shadow shadow-green-400 font-bold' : 'border-dashed border-2 border-zinc-400'}`} onClick={(e) => setSelectPacking('10 strips')}>10 strips</span>
                                        </p>
                                    </div>
                                )
                            })}
